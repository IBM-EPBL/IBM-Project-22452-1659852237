disease_dic = {
    'Pepper,_bell___Bacterial_spot': """ <centre><b>Crop</b>: Pepper <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
        ...
        <br/><br/><b>The FERTILIZER components that are suggested</b>
        <br/> <ul> <li>copper and pyrethrins </li> 
           <li>Sulphur</li></ul>""",
    ...
    'Potato___Early_blight': """ <b>Crop</b>: Potato <br/>Disease: Early Blight<br/>
        ...
        <br/><br/><b>The FERTILIZER components that are suggested</b>
        <br/><ul> <li>Azox ystrobin </li>
        <li>Boscalid </li>
        <li>Chlorothalonil </li>
        <li>Famoxadone/cymoxanil </li>
        <li>Fenamidone </li>
         <li>Iprodione </li>
         <li>Mancozeb </li>
         <li>Pyraclostrobin </li></ul>
        """,
    ...
    'Potato___Late_blight': """ <b>Crop</b>: Potato <br/>Disease: Late Blight<br/>
        ...
        <br/><br/><b>The FERTILIZER components that are suggested</b>
             <br/><ul><li>   Azoxystrobin </li>
             <li>   Cymoxanil </li>
             <li>   Chlorothalonil </li>
             <li>   Dimethomorph</li>
             <br/>   Famoxadone/cymoxanil </li>
             <li>   Fenamidone</li>
              <li>  Mancozeb </li>
             <li>   Mefenoxam/chlorothalonil </li>
             <li>   Propamocarb hydrochloride</li>
    ...
    'Tomato___Late_blight': """ <b>Crop</b>: Tomato <br/>Disease: Late Blight<br/>
        ...
        <br/> 3. The host range is typically limited to potato and tomato, but hairy nightshade (Solanum physalifolium) is a closely related weed that can readily become infected and may contribute to disease spread. Under ideal conditions, such as a greenhouse, petunia also may become infected.
        <br/><br/><b>The FERTILIZER components that are suggested</b>
                <br/><ul> <li>   Chlorothalonil</li>
                <br/>  <li>  Mancozeb</li>
                 <br/>  <li> Copper</li>
                    <li>Famoxadone/cymoxanil</li>
                    <li>Dimethomorph</li>
                    <li>Azoxystrobin</li>
                    <li>Azoxystrobin + Difenoconazole</li> 
                    <li>pyraclostrobin</li></ul>
        """,
